...
<head>
  ...
  <meta charset="utf-8" />
  <title>Fresh Prints | Sign up</title>
...
<script type="text/javascript">/* remove disable attribute from submit button > signup when T&C's checked */
